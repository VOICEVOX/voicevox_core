...
pub const fn error_result_to_message(result_code: VoicevoxResultCode) -> &'static str {
    ...
    match result_code {
        ...
        VOICEVOX_VVM_MODEL_READ_ERROR => "Modelを読み込めなかった\0",
        VOICEVOX_ALREADY_LOADED_MODEL_ERROR => "すでに読み込まれているModelを読み込もうとした\0",
        VOICEVOX_UNLOADED_MODEL_ERROR => "Modelが読み込まれていない\0",
    }
}
