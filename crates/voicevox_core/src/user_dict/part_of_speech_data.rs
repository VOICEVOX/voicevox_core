...
pub fn word_type_to_part_of_speech_detail(value: &UserDictWordType) -> PartOfSpeechDetail {
    match value {
        UserDictWordType::ProperNoun => PartOfSpeechDetail {
        ...
        UserDictWordType::CommonNoun => PartOfSpeechDetail {
            part_of_speech: "名詞".to_string(),
        ...
        UserDictWordType::Verb => PartOfSpeechDetail {
        ...
        UserDictWordType::Adjective => PartOfSpeechDetail {
        ...
        UserDictWordType::Suffix => PartOfSpeechDetail {
            part_of_speech: "名詞".to_string(),
