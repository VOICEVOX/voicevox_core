...
use super::word::*;
use crate::{Error, Result, UuidKey};

/// ユーザー辞書。
#[derive(Clone, Debug, Default, Getters)]
pub struct UserDict {
    words: HashMap<UuidKey, UserDictWord>,
}
...
impl UserDict {
    ...
    pub fn load(&mut self, store_path: &str) -> Result<()> {
        ...
        let words: HashMap<UuidKey, UserDictWord> =
